# -*- coding: utf-8 -*-
"""
Created on Fri Jul  3 17:17:34 2020
...
nom_count_dict = {}
def increase_count(dic, director):
    dic[director]=dic.get(director,0)+1

[increase_count(nom_count_dict, director) for key in nominated for director in nominated[key]]
# Add your code here
...
win_count_dict = {}
# Add your code here
[increase_count(win_count_dict, director) for key in winners for director in winners[key]]
...
most_win_director = []
# Add your code here
[increase_count(all_win_director, director) for key in winners for director in winners[key]]
sorted_list=sorted(all_win_director.items(), key = lambda x:(x[1]), reverse=True)

first_item=sorted_list[0]
for item in sorted_list:
    if first_item[1]==item[1]:
        most_win_director.append(item[0])
    else:
        break
